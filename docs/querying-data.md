...
`otlp2parquet` produces standard Parquet files that can be queried by a wide range of tools. The best way to query your data depends on which storage layer you are using.
...
All examples in our documentation use DuckDB.

## Querying Guides

*   **[Querying Parquet Files Directly](../storage/object-storage.md#querying)**
    *   Choose this if you are using the basic object storage layer without a table format.

*   **[Querying via an Iceberg Catalog](../storage/iceberg.md#querying)**
