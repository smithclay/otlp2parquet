...
- Platform crates: `otlp2parquet-cloudflare` (WASM, R2-only, optional R2 catalog), `otlp2parquet-lambda` (S3/S3 Tables), `otlp2parquet-server` (Axum, multi-backend). `otlp2parquet-proto` holds generated OTLP protos.
